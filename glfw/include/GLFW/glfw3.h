...
/*! @brief Mouse input window hint and attribute
 *
 *  Mouse input [window hint](@ref GLFW_MOUSE_PASSTHROUGH_hint) or
 ...
 *  @ingroup input
 */
GLFWAPI void glfwGetCursorPos(GLFWwindow* window, float* xpos, float* ypos);
